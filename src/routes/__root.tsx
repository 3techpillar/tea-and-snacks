...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()(
  {
    ...
    head: () => ({
      meta: [
        ...
        { title: "Easy Food — Food court ordering" },
        {
          name: "description",
          content:
            "Order tea, snacks and meals from your food court vendors in a few taps.",
        },
        { property: "og:title", content: "Easy Food — Food court ordering" },
        {
